...
namespace BackwardChaining
{
    ...
    {        
        ...
        // Cho biet mau nay co bao nhieu bien
        public int CountVariable
        {
            get
            {
                return _CountVariable(this);
            }
        }
        #endregion 
        ...
        #endregion
        #region ExtraName : Them extra vao truoc ten cua moi bien
        public _Composite ExtraName(String extra)
        {
            _Composite result = new _Composite(this);
            _ChangeName(extra, result);
            return result;
        }
        #endregion
        ...
        {
            ArrayList result;
            result = _GetListOfVariable(this);
            return result;
        }
        #endregion
        ...
        {
            ArrayList result;
            result = _GetListOfVariable2(this);
            return result;
        }
        #endregion
        #endregion
