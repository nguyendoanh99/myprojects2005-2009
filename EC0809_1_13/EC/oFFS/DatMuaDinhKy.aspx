<%@ Page Language="C#" MasterPageFile="~/MPInstock_Guest.master" AutoEventWireup="true" CodeFile="DatMuaDinhKy.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div id="section9"> 
    <fieldset>
    <legend>Thông tin định kỳ</legend>

        <div class="forminput">
                <div id="div12" class="formlabel"> <label>Loại định kỳ</label> </div>
                 <div class="formfield"> 
                    <select id="cmbLoaiDK" onchange="XL_DonHang.ChonLoaiDinhKy()"></select>
                        <script type="text/javascript">
                            XL_DonHang.LayDSLoaiDK('cmbLoaiDK');
                        </script>
                </div>
        </div>
            
        <div class="forminput">
                <div id="div17" class="formlabel"> <label>Ngày bắt đầu</label> </div>
                <div class="formfield"> 
                    <select id="cmbNgayBD"></select>
                    <select id="cmbThangBD"></select>
                    <select id="cmbNamBD"></select>
                        <script type="text/javascript">
                        XL_DonHang.LoadCmbNum('cmbNgayBD', 1, 31);
                        XL_DonHang.LoadCmbNum('cmbThangBD', 1, 12);
                        XL_DonHang.LoadCmbNum('cmbNamBD', 2008, 2010);
                        </script>
                </div>
        </div>
        
        <div class="forminput">
                <div id="div10" class="formlabel"> <label>Ngày kết thúc</label> </div>
                <div class="formfield"> 
                    <select id="cmbNgayKT"></select>
                    <select id="cmbThangKT"></select>
                    <select id="cmbNamKT"></select>
                        <script type="text/javascript">
                        XL_DonHang.LoadCmbNum('cmbNgayKT', 1, 31);
                        XL_DonHang.LoadCmbNum('cmbThangKT', 1, 12);
                        XL_DonHang.LoadCmbNum('cmbNamKT', 2008, 2020);
                        </script>
                </div>
        </div>
        
        <div id="Div20" class="forminput">
            <div class="formlabel"> <label>Thời gian giao định kỳ</label> </div>
            <div class="formfield"> 
                <table>
                    <tr>
                        <td align="right" style="width: 193px; height: 18px;" id="tdDS"></td>
                         <td style="width: 30px; height: 18px;"></td>
                         <td align="right" style="width: 179px; height: 18px;" id="tdDSChon"></td>
                    </tr>
                    
                    <tr>
                        <td align="center" style="width: 193px; height: 146px;">
                            <select id="listDS" size="7" style="width: 191px"></select>
                        </td>
                        
                        <td style="width:30px; height: 146px;">
                            <input type="button" id="chon" value='&nbsp;&gt;&nbsp;' onclick="ChonItem()"/>
                            <br />
                            <input type="button" id="chontatca" value='&gt;&gt;' onclick="ChonTatCaItem()"/>
                            <br />
                            <input type="button" id="bo" value='&nbsp;&lt;&nbsp;' onclick="BoItem()"/>
                            <br />
                            <input type="button" id="botatca" value='&lt;&lt;' onclick="BoTatCaItem()"/>
                        </td>
                        
                        <td style="width: 179px; height: 146px;">
                            <select id="listDSChon" size="7" style="width: 179px"></select>
                        </td>                  
                   </tr>
                </table>
            </div>
    ...
    <legend>Hình Thức Khuyến Mãi</legend>
        ...
        <div id="DiemSuDung" class="forminput">
            ...
            <div class="formfield"> <select id="cmbDiemSD" onchange="TinhTien()" disabled="true"></select></div>
        </div>
        
        <div class="forminput">
                <div id="div2" class="formlabel"> <label>Số tiền tương ứng</label> </div>
                <div id="div3" class="formlabel_left"> <label id="lbSoTien"></label> </div>
        </div><br />
        ...
        <div id="ChonQuaTang" class="forminput">
            ...
            <input type="button" id="btChon" disabled="disabled"value="Chọn" onclick="return ClickChonQuaTangDinhKy()"/>
        </div>
        
        <div id="Div4">
        <fieldset>
        <legend>Danh Sách Quà Tặng</legend>
            ...
            <div id="Div6"class="forminput">
                ...
                <div id="div_GTQT" class="formlabefl_left"> </div> 
            </div>
    ...
    <legend>Hình Thức Thanh Toán</legend>
            ...
            <div class="formfield"> 
                <select id="cmbHTTT" onchange="ChonHinhThucThanhToan()"></select>
                    <script type="text/javascript">
                        ...
                        document.getElementById('pathway').innerHTML += 'Đặt mua hàng định kỳ';
                    </script>
            </div>
       </div>
       ...
       <fieldset>
            ...
            <div class="forminput">
                ...
                <div class="formfield"><input type="text" disabled="disabled" name="txtSoThe" size="40" id="txtSoThe" runat="server"/></div>
            </div>
    ...
    <div class="forminput">
            ...
            <div class="formfield">
                <input type="button" id="btnQuayLai" value="Quay lại" onclick="return btnQuayLai_onclick()" />
                <input type="button" id="btnThanhToan" value="Đặt hàng" onclick="XL_DonHang.DatHang(3)" />
                <input type="button" id="btnLuu" value="Lưu đơn hàng" onclick="XL_DonHang.DatHang(2)" />
    ...
    <script type="text/javascript">
        ...
        XL_DonHang.LayTrangThaiFormDinhKy();
    </script>
</asp:Content>
