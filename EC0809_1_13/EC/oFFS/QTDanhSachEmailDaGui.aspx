<%@ Page Language="C#" MasterPageFile="~/MPAdmin.master" AutoEventWireup="true" CodeFile="QTDanhSachEmailDaGui.aspx.cs" Inherits="QTDanhSachEmailDaGui" Title="Untitled Page" %>
...
<!--CSS file (default YUI Sam Skin) --> 
    ...
    <script type="text/javascript" src="He Khach/XL_QTDanhSachEmailDaGui.js"></script>    
   <LINK href="css/template[1].css" type="text/css" rel="stylesheet">

   <div class="ushead" > 
		<div class="uscontentheading"><h3>Danh sách các email đã gửi</h3></div> 
	</div> 
    ...
    <br />
    <span style="font-size:x-large">Nội dung email</span><br />
    <div id="body"> 
                </div>
