<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="NVCapNhatThongTinCaNhan.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
   ...
   <fieldset>
        ...
        <div class="forminput">
            <div class="formfield"><center>
                <input type="button" id="but_Luu" value="Lưu" onclick="CapNhatThongTinCaNhan(1)"/>
                <input type="button" id="btnThoat" value="Trở về" onclick="window.location='NVXemThongTinCaNhan.aspx?t='+new Date().getTime();"/>
            </center></div>
        </div><br />
   </fieldset>
   </div>
