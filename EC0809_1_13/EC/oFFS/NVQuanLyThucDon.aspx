<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="NVQuanLyThucDon.aspx.cs" Inherits="NVQuanLyThucDon" Title="Untitled Page" %>
...
<!--CSS file (default YUI Sam Skin) --> 
    ...
    <script type="text/javascript" src="He Khach/XL_NVQuanLyThucDon.js"></script>    
   <LINK href="css/template[1].css" type="text/css" rel="stylesheet">
     <div class="ushead" > 
		<div class="uscontentheading"><h3>Danh sách thực đơn</h3></div> 
	</div> 
