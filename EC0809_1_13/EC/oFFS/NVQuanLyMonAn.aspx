<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="NVQuanLyMonAn.aspx.cs" Inherits="NVQuanLyMonAn" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript" src="He Khach/XL_NVQuanLyMonAn.js"></script>    
   <LINK href="css/template[1].css" type="text/css" rel="stylesheet">
    <div class="ushead" > 
		<div class="uscontentheading"><h3>Danh sách món ăn</h3></div> 
	</div> 
