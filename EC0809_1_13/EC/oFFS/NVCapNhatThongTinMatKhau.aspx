<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="NVCapNhatThongTinMatKhau.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
   ...
   <fieldset>
        ...
        <div class="forminput">
            <div class="formfield"><center>
                ...
                <input type="button" id="but_Thoat" value="Trở về" onclick="window.location='NVXemThongTinCaNhan.aspx?t='+new Date().getTime()"/>
            </center></div>
        </div>
   </fieldset>
   </div>
