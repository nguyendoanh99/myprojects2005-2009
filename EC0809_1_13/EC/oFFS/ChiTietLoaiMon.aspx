<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="ChiTietLoaiMon.aspx.cs" Inherits="ChiTietLoaiMon"%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <% Response.Write("<script type=\"text/javascript\"> var maLoaiMon=" + Request["loai"] + "; </script>"); %>
    ...
    <div class="ushead" > 
		<div class="uscontentheading"><h3>Danh sách món ăn của loại món</h3></div> 
	</div> 
    ...
    <div class="yui-skin-sam">
        <div class="forminput">
            <div class="formlabel" id="divcha"> </div>
        </div> 
     
        <div id="divDanhSachMon">
        </div>
    </div>
    <script type="text/javascript">
        XL_MON_AN.LayDanhSachMon();
    </script>   
