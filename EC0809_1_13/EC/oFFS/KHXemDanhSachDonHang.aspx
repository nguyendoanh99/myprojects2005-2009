<%@ Page Language="C#" MasterPageFile="~/MPInstock_Guest.master" AutoEventWireup="true" CodeFile="KHXemDanhSachDonHang.aspx.cs" Inherits="KHXemDanhSachDonHang" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <% Response.Write("<script type=\"text/javascript\"> var loaiDonHang=" + Request["loai"] + "; </script>"); %>
    ...
    <script type="text/javascript" src="He Khach/XL_KHXemDanhSachDonHang.js"></script>    
   <LINK href="css/template[1].css" type="text/css" rel="stylesheet">
    
   <div class="ushead" > 
		<div class="uscontentheading"><h3>Danh sách đơn hàng</h3></div> 
	</div> 
