<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="NVXemThongTinCaNhan.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <fieldset>
        ...
        <div class="formedit"><a href="NVCapNhatThongTinCaNhan.aspx">Cập nhật</a></div>
   </fieldset>
   </div>
   <hr />
   ...
   <fieldset>
        ...
        <div class="forminput">
            ...
            <div id="div_MatKhau2" class="formlabel_left"> <a href="NVCapNhatThongTinMatKhau.aspx">Thay đổi mật khẩu</a> </div>
        </div><br />
   </fieldset>
   </div>
   <hr />   
