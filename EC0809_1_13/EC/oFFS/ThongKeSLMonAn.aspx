<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="ThongKeSLMonAn.aspx.cs" Inherits="ThongKeSLMonAn" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="section1">
    <h2>THỐNG KÊ SỐ LƯỢNG MÓN ĂN ĐÃ BÁN
    </h2>  
    </div>
    <hr />
    ...
    <div id="Div3" class="forminput">
        <div class="formlabel"> <label>Món ăn : </label></div>
        <div class="formfield"> 
            <select id="cmbMonAn"></select>
               <script type="text/javascript">
                       XL_ThongKe.LayDSTenMonAn('cmbMonAn');
            </script>
        </div>
     </div>
    ...
    <div class="forminput">
            ...
            <div class="formfield">
                &nbsp;<input type="button" id="btnThucHien" value="Đồng ý" onclick="XL_ThongKe.LoadKqThongKeMonAn()" /></div>            
    </div>
