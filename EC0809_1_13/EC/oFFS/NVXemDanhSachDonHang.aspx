<%@ Page Language="C#" MasterPageFile="~/MPVirtueMart.master" AutoEventWireup="true" CodeFile="NVXemDanhSachDonHang.aspx.cs" Inherits="NVXemDanhSachDonHang" Title="Untitled Page" %>
...
<% Response.Write("<script type=\"text/javascript\"> var loaiDonHang=" + Request["loai"] + "; </script>"); %>
    ...
    <script type="text/javascript" src="He Khach/XL_NVXemDanhSachDonHang.js"></script>    
    <LINK href="css/template[1].css" type="text/css" rel="stylesheet">
    
     <div class="ushead" > 
		<div class="uscontentheading"><h3><label id="_title" ></label></h3></div> 
	</div> 
