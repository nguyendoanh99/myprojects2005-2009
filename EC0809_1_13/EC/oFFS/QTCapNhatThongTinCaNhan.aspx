<%@ Page Language="C#" MasterPageFile="~/MPAdmin.master" AutoEventWireup="true" CodeFile="QTCapNhatThongTinCaNhan.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
   ...
   <fieldset>
        ...
        <div class="forminput">
            <div class="formfield"><center>
                ...
                <input type="button" id="btnThoat" value="Trở về" onclick="window.location='QTXemThongTinCaNhan.aspx?t='+new Date().getTime();"/>
            </center></div>
        </div><br />
   </fieldset>
   </div>
