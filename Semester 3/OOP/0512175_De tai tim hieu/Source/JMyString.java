...
class JMyString
{
	...
	// Ham cong vao cuoi chuoi
	public JMyString Append(String Q)
	{
		JMyString P = new JMyString(Q);
		return Append(P.m_str);
	}
	public JMyString Append(JMyString P)
	{		
		return Append(P.m_str);
	}	
	public JMyString Append(char []str)
	{
		// Neu str dung la 1 chuoi thi moi thuc hien viec cong chuoi
		if (str != null)
		{			
			char []strKQ = new char[m_str.length + str.length];
			// Neu khong con du bo nho de cap phat thi thoat
			// nguoc lai thuc hien phep cong don chuoi str vao chuoi m_str
			if (strKQ != null)
			{
				strcpy(strKQ, m_str);
				strcat(strKQ, str, m_str.length);				
				m_str = strKQ;
			}
		}
	...
	public JMyString Append(char c)
	{
		char []arr = {c};
		return Append(arr);
	}
	// Lay ky tu thu iViTri cua chuoi
	public char charAt(int iViTri)
	{
	...
	public boolean GreaterEqualTo(char c)
	{
		char []s = {c};
		return GreaterEqualTo(s);
	}
	...
	public boolean LessEqualTo(char c)
	{
		char []s = {c};
		return LessEqualTo(s);
	}
	...
	public int CompareNoCase(char c)
	{
		char[] s = {c};
		return CompareNoCase(s);
	}
