...
/* to check login, valid author and for comfirmation message to perform an author action*/ 	
   ...
   function ChangeByBlogLeaders()
    ...
    { 
     ...
     /* Functions for rotating the yesterday leader */
     function ChangeByYesterdayLeader()
    { 
        if(document.getElementById("ctl00_ContentPlaceHolder3_HomeRightBar1_YesterdaysLeader1_hideNum") != null)
        maxBLeaders = parseInt(document.getElementById("ctl00_ContentPlaceHolder3_HomeRightBar1_YesterdaysLeader1_hideNum").value); 
        if(checkBLeaders == -1)
        setTimeout("forSetTimeYesterdayLeader()",1);
        else
        setTimeout("forSetTimeYesterdayLeader()",5000);
    }
    
    function forSetTimeYesterdayLeader()
    { 
        checkBLeaders++;
        if(checkBLeaders == maxBLeaders)
        checkBLeaders = 0; 
        HideShowYesterdayLeader(checkBLeaders);
        ChangeByYesterdayLeader();
    }

    function HideShowYesterdayLeader(checkBLeaders)
    { 
        if(document.getElementById("ctl00_ContentPlaceHolder3_HomeRightBar1_YesterdaysLeader1_onlyOneRow") != null)
        { 
            if(document.getElementById("ctl00_ContentPlaceHolder3_HomeRightBar1_YesterdaysLeader1_hide"+checkBLeaders) != null)
            { 
                document.getElementById("ctl00_ContentPlaceHolder3_HomeRightBar1_YesterdaysLeader1_onlyOneRow").innerHTML = document.getElementById("ctl00_ContentPlaceHolder3_HomeRightBar1_YesterdaysLeader1_hide"+checkBLeaders).value;
            }
        }
    }